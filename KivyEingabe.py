...
class Kletterer:
    ...
    def Versuch(self, instance):
        self.VersuchListe.append("V")
    
    def Bonus(self, instance):
        try:
...
class EingabeApp(App):
    ...
    def build(self):
        ...
        btn1.bind(on_press=partial(Kletterer.Versuch, instance))
        layout.add_widget(btn1)

        btn2 = Button(text="Bonus")
        btn2.bind(on_press=partial(Kletterer.Bonus, instance))
        layout.add_widget(btn2)

        btn3 = Button(text="Top")
        btn3.bind(on_press=partial(Kletterer.Top, instance))
        layout.add_widget(btn3)

        btn4 = Button(text="Fertig")
        btn4.bind(on_press=partial(Kletterer.Fertig,instance))
